 ...
 <div className="header">
  <div className="logo">
   {/* <svg viewBox="0 0 513 513" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <button id="log-out" onClick={this.logout}>Logout</button>
  </div>
  <div className="search-bar">
   <input autoComplete="fasle" type="text" id="contactSearch" placeholder="Search users..." />
  </div>
  <button id="add-contact" onClick={this.addContact}>Add Contact</button>
